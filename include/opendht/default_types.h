...
class RING_PUBLIC DhtMessage : public Value::Serializable<DhtMessage>
{
public:
...
template <typename T>
class RING_PUBLIC SignedValue : public Value::Serializable<T>
{
private:
...
template <typename T>
class RING_PUBLIC EncryptedValue : public SignedValue<T>
{
public:
...
class RING_PUBLIC ImMessage : public SignedValue<ImMessage>
{
private:
...
class RING_PUBLIC TrustRequest : public EncryptedValue<TrustRequest>
{
private:
...
class RING_PUBLIC IceCandidates : public EncryptedValue<IceCandidates>
{
private:
...
/* "Peer" announcement
 */
class RING_PUBLIC IpServiceAnnouncement : public Value::Serializable<IpServiceAnnouncement>
{
private:
...
RING_PUBLIC extern const std::array<std::reference_wrapper<const ValueType>, 5> DEFAULT_TYPES;

RING_PUBLIC extern const std::array<std::reference_wrapper<const ValueType>, 1> DEFAULT_INSECURE_TYPES;
