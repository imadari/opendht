...
struct RING_PUBLIC Value
{
    ...
    RING_PUBLIC friend std::ostream& operator<< (std::ostream& s, const Value& v);
 ...
 */
struct RING_PUBLIC FieldSelectorDescription
{
...
struct RING_PUBLIC Select
{
    ...
    RING_PUBLIC friend std::ostream& operator<<(std::ostream& s, const dht::Select& q);
private:
...
struct RING_PUBLIC Where
{
    ...
    RING_PUBLIC friend std::ostream& operator<<(std::ostream& s, const dht::Where& q);
...
struct RING_PUBLIC Query
{
    ...
    RING_PUBLIC friend std::ostream& operator<<(std::ostream& s, const dht::Query& q) {
 ...
 * in Value.
 */
struct RING_PUBLIC FieldValueIndex {
    FieldValueIndex() {}
    ...
    RING_PUBLIC friend std::ostream& operator<<(std::ostream& os, const FieldValueIndex& fvi);
